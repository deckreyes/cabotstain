...
fetch('https://main--cabotstain--deckreyes.aem.page/deck.json?sheet=wood')
  ...
  .then(response => {
    ...
    document.getElementById('wood2').innerHTML += "<img loading=\"eager\"  src=\"" + response.data[1].image + "?width=200&amp;format=jpg&amp;optimize=medium\" width=\"200\" height=\"200\">"
    ...
    document.getElementById('wood6').innerHTML += "<img loading=\"eager\"  src=\"" + response.data[5].image + "?width=200&amp;format=jpg&amp;optimize=medium\" width=\"200\" height=\"200\">"
